...
// Используем версию с поддержкой stl
...
public:
	...
	*/
	...
	const std::string & AttributeStr( const std::string& name ) const   { return AttributeStr( name.c_str() ); }
...
public:
	...
	*/
	...
	/// Load a xml using the given data. Returns true if successful. [new 27.04]
	bool LoadData( char * data, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
