...
public:
	...
	/*! \remarks Sets the name of this layer.
		\param const MSTR \&name - The name for this layer. */
	...
	/*! \remarks Sets the wire frame color.
		\param DWORD newcol - See <a href="idx__r_colorref_html.html">COLORREF</a>.
		\param bool propagate - Use true to pass the value to child layers, false to set just this one layer */
	...
	/*! \remarks Sets the hidden state.
		\param bool onOff - Use true for hidden; false for not hidden. 
		\param bool propagate - Use true to pass the value to child layers, false to set just this one layer */
	...
	/*! \remarks Sets the frozen state.
		\param bool onOff - Use true for on; false for off. 
		\param bool propagate - Use true to pass the value to child layers, false to set just this one layer */
	...
	/*! \remarks Sets the visibility at the specified time
		\param TimeValue t - The time at which to set the value
		\param float vis - The new value for visibility */
	virtual void SetVisibility(TimeValue t, float vis) = 0;
	/*! \remarks Gets the visibility at the specified time
		\param TimeValue t - Unused. 
		\param Interval valid - Unused. */
	...
	/*! \remarks Sets the renderable state.
		\param bool onOff - Use true for renderable; false for not renderable. 
		\param bool propagate - Use true to pass the value to child layers, false to set just this one layer */
	...
	/*! \remarks This method allows you to set the inherit visibility flag for the layer.
		\param bool onOff - TRUE to set; FALSE to unset. */
	...
	/*! \remarks This method returns the state of the motion blur flag at the specified time.
		\param TimeValue t - The time at which to get the flag. */
	...
	/*! \remarks This method allows you to set the state of the motion blur flag at the specified time.
		\param TimeValue t - The time at which to set the flag.
		\param bool onOff - TRUE to turn on; FALSE to turn off. */
	...
	/*! \remarks This method allows you to set the motion blur multiplier for the layer.
		\param TimeValue t - The timevalue to get the motion blur multiplier for. */
	virtual float GetImageBlurMultiplier(TimeValue t) const = 0;
	/*! \remarks This method allows you to set the image blur multiplier.
		\param TimeValue t - The timevalue to set the image blur multiplier for.
		\param float m - The multiplier to set. */
	...
	/*! \remarks Deletes the specified node from this layer. 
		...
		\param INode *rtarg - The node to delete from this layer. */
	...
	/*! \remarks Sets the parent layer for this layer.
		\param ILayer *parentLayer - The layer that will become the parent layer.
	...
	/*! \remarks Returns a pointer to the Nth child Layer for this layer. 
		\param int n - The index of the child layer.
	...
	/*! \remarks This method returns the render flags associated with the layer.
		\internal
		\param int oldlimits - The old limits flag. */
