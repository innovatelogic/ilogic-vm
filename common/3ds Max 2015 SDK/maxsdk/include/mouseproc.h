...
public:
    ...
    <a href="idx__r_list_of_mouse_callback_messages_html.html">List of Mouse Callback
    Messages</a>.\n\n
    <b>int point</b>\n\n
    ...
    <a href="idx__r_list_of_mouse_callback_flags_html.html">List of Mouse Callback
    Flags</a>.\n\n
    <b>IPoint2 m</b>\n\n
