...
public:
	...
	/*! \remarks Unfortunately, several render elements derive from MaxRenderElement class
		...
		actually are not appliccable. 
		Therefore, this was added, and it returns TRUE if the element is actually 
