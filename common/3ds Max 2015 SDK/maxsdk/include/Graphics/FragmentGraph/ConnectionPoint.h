...
namespace MaxSDK { namespace Graphics {
	...
	*/
	...
	to its owner fragment, and the input/output data type. Only the input/output 
	...
	*/
	...
	public:
		...
		*/
		...
		/** Get the pointer to owner view fragment.
		...
		*/
		...
		/** Get the data type of this connection point. Once the connection point 
		is created, its data type is fixed and cannot be changed anymore.
	...
	/** Class that stores input information of a fragment. An input can only be 
	...
	*/
	...
	public:
		...
		*/
		...
		/** Get the data source that connects to this input. 
		...
		*/
		...
		/** Set the source of this input. This source could be an output from a fragment node or 
			a fragment graph.
		\param[in] pVarSrouce the source of this input
	...
	/** Class that stores output information of a fragment. An output can be 
	...
	*/
	...
	public:
		...
		*/
		...
		/** Get the i-th connected inputs.
		\param[in] i the index of the input in this output class.
		\return pointer to the i-th connected inputs.
		*/
		FragmentGraphAPI Input* GetVarTarget(size_t i) const;
		
		/** Get the variable that stores in the output.
		...
		*/
		...
		\return true if the type of the variable is compatible with the type of 
				this output or false otherwise.
		*/
