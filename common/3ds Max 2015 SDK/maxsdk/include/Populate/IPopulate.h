...
namespace MaxSDK 
{
	namespace Populate 
	{
		...
		characters and sets them to high resolution.  This code will only do something if Popluate objects exist in the scene.
		...
		// change the resoultion of the characters to high resolution
		...
		class IPopulate : public  FPStaticInterface
		{
		  public:
			...
			enum TurnOptimizationType{ 
				...
				eMaxdistribution,
				//! \brief Chooses turns to minimize distance travelled through intersections
				eMindistance,
			...
			//! If you delete characters or resimulate, these functions may return different values than they did after a previous simulation.
