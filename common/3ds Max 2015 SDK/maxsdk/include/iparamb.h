...
\par Data Members:
<b>ParamType type</b>\n\n
The parameter type. See <a href="idx__r_list_of_parameter_types_html.html">List of
Parameter Types</a>.\n\n
<b>UserType *user</b>\n\n
...
class IParamBlock : 			
	...
	public:
		...
		<a href="idx__r_list_of_parameter_types_html.html">List of Parameter Types</a>. */
...
public:
	/*! \brief Constructor.
	\param ParamVersionDesc* versions - This is an array of ParamVersionDescs.
	\param int count - The number of elements in the array specified above.
	\param ParamVersionDesc* current - This is a pointer to the current version of the ParamVersionDesc.
	\param ReferenceTarget* target - This is a pointer to a reference target. This is usually the this pointer of the object.
	\param int refNum - This is the reference index of the parameter block.
