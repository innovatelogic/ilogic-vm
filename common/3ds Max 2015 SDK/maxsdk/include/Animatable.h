...
//@{
		...
		*/
		...
		\sa  Class ClassID, <a href="idx__r_list_of_class_ids_html.html">List of Class IDs</a>.
		*/
...
//@}
		...
		*/
		...
		developer chooses).
		\param flags See <a href="idx__r_list_of_sch_view_addanimflags_html.html">List of
		...
		\param id This is usually the sub-anim number (but can actually be any value the
		developer chooses).
		\param flags See <a href="idx__r_list_of_sch_view_addanimflags_html.html">List of Schematic %View
