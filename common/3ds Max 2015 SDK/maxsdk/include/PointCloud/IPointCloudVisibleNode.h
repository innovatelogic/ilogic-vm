...
#pragma warning(default:4201)		
	...
	//! \brief structure that contains the basic information of a point cloud vertex.
	struct DllExport PointCloudVertex : public MaxHeapOperators
	{
		//! the vertex position in point cloud local space
	...
	//! provides methods to get information of the point cloud vertices the voxel node contains.
	//! This interface can be retrieved by calling IPointCloud::CreateIPointCloudVisibleVoxelNodes method.
