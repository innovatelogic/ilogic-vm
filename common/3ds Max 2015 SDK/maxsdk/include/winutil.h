 ...
 * \param reservedSpace   Reserved space in pixels that reduces string display area in hWnd
*/
 ...
 *
 * \param hDlg[in]            The hWnd of the Dialog the Listbox is in 
 * \param nIDDlgItem[in]      The id of the Listbox in the dialog.
 * \param nListboxItem[in]    The index of the Listbox item
 ...
 * \param nIDDlgItem[in]      The id of the Listbox in the dialog.
 * \param nListboxItem[in]    The index of the Listbox item
 * \param itemText[out]       The Listbox item's string 
 *
 * If the ListBox is not found, an empty string is returned
*/
 ...
 * Returns a Listbox item's string as a TSTR.
 *
 * \param hListBoxWnd[in]     Window handle of ListBox 
 * \param nListboxItem[in]    The index of the Listbox item
 * \return the Listbox item's string
 *
 * If the ListBox is not found, an empty string is returned
 ...
 *
 * \param hDlg[in]            The hWnd of the Dialog the Combobox is in 
 * \param nIDDlgItem[in]      The id of the Combobox in the dialog.
 * \param nComboboxItem[in]   The index of the Combobox item
 ...
 * \param nIDDlgItem[in]      The id of the Combobox in the dialog.
 * \param nComboboxItem[in]   The index of the Combobox item
 * \param itemText[out]       The Combobox item's string 
 *
 * If the Combobox is not found, an empty string is returned
*/
 ...
 * Returns a Combobox item's string as a TSTR.
 *
 * \param hComboBoxWnd[in]    Window handle of ComboBox 
 * \param nComboboxItem[in]   The index of the Combobox item
 * \return the Combobox item's string
 *
 * If the Combobox is not found, an empty string is returned
 ...
 *
 * \param hDlg[in]            The hWnd of the Dialog the window is in 
 * \param nIDDlgItem[in]      The id of the window in the dialog.
 ...
 * \param hDlg[in]            The hWnd of the Dialog the window is in 
 * \param nIDDlgItem[in]      The id of the window in the dialog.
 * \param windowText[out]     The window's text 
 *
 * If the window is not found, an empty string is returned
*/
...
* Returns an window's text as a TSTR.
 *
 * \param hWnd[in]            The Window handle
 * \return the window's string
 *
 * If the window is not found, an empty string is returned
*/
