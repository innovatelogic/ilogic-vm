...
public:
    ...
    viewports.\n\n
    <b>int flags</b>\n\n
    See <a href="idx__r_list_of_display_flags_html.html">List of Display Flags</a>.
...
/*! \sa  Class BaseInterfaceServer,  Class PolyShape, Class Mesh,  Class Point3,  Class Point2, Class Matrix3, Class HitRegion, Class GraphicsWindow, Class ViewExp, Class INode, <a href="idx__r_list_of_marker_types_html.html">List of Marker Types</a>,
~{ Hit Testing }~\n\n
\par Description:
...
<a href="idx__r_list_of_marker_types_html.html">List of Marker Types</a>\n\n
<b>MSTR* mpText</b>\n\n
...
public:
    ...
    ManipExport ManipulatorGizmo(Mesh* pMesh, DWORD flags,
	 ...
	 The marker type. See the <a href="idx__r_list_of_marker_types_html.html">List of
	 Marker Types</a>\n\n
	 <b>Point3\& position</b>\n\n
	 The marker position.\n\n
	 <b>DWORD flags</b>\n\n
...
/*! \sa  Class FPMixinInterface,  Class SimpleManipulator, Class Interface, Class PolyShape, Class Mesh,  Class Point3,  Class Point2, Class ViewExp, Class IColorManager, Class Ray, Class ManipHitData, <a href="idx__r_list_of_marker_types_html.html">List of Marker Types</a>\n\n
\par Description:
...
/*! \sa  Class Manipulator, Class ISimpleManipulator, Class PolyShape, Class GizmoShape, Class ReferenceTarget, Class IParamBlock2, Class INode, Class Mesh,  Class Point3, Class Point2, Class ViewExp, Class IColorManager, Class Ray, Class ManipHitData, <a href="idx__r_list_of_marker_types_html.html">List of Marker Types</a>\n\n
\par Description:
