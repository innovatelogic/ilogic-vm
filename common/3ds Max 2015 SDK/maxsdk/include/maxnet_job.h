...
/*! \sa Class MaxNetManager, Class CJobText, Structure TextBufferOutput, Structure JobRenderElements, <a href="idx__r_list_of_job_text_types_html.html">List of Job Text Types</a>
\remarks This structure is available in release 4.0 and later only. \n\n
...
struct JobText: public MaxHeapOperators {
	/*! The %Job Text type. See the <a href="idx__r_list_of_job_text_types_html.html">List of Job Text Types</a> for details. */
	JOB_TEXT_TYPE type;
	union {
...
/*! \sa  MaxNetCallBack, JobText, <a href="idx__r_list_of_job_text_types_html.html">List of Job Text Types</a>\n\n
\par Description:
...
class MAXNETEXPORT CJobText: public MaxHeapOperators {
	...
	public:
		...
		*/
		...
		Refer to the <a href="idx__r_list_of_job_text_types_html.html">List of Job
