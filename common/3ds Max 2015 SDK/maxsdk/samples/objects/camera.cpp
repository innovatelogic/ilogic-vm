...
protected:
	...
	float mLastDist;
public:
	CameraTargetLineItem(SimpleCamera* cam)
		: mpCamera(cam)
		, mLastDist(-1.0f)
	{
...
#else
SimpleCamera::SimpleCamera(int look) : targDist(0.0f), mStereoCameraCallBack(NULL)
#endif // NO_CAMERA_MULTIPASS
{
	...
	MaxSDK::Graphics::IRenderItemContainer& targetRenderItemContainer)
{
	...
	pLineItem = new CameraTargetLineItem(this);
...
RefResult ParallelCamera::NotifyRefChanged(const Interval& changeInt,RefTargetHandle hTarget,PartID& partID, RefMessage message, BOOL propagate) 
{
  switch(message)
  {		
	case REFMSG_GET_PARAM_DIM:
