...
//		DbgAssert(res);
	...
	//	boneIndex which bone to weight to
	//	amount the absolute amount(weight)
	void SetVertex(BoneModData *bmd, int vertID, int boneIndex, float amount);
	...
	void SetVertices(BoneModData *bmd,int vertID, const Tab<int>& boneIndexList, const Tab<float>& amountList);
