...
#define CHAMFER_EDGE_STANDARD_PNG       _T("StdChamfer.png")
...
public:
	...
	enum OurGrips{eChamferEdgeType = 0, eChamferEdgeAmount, eChamferEdgeSegments, eChamferEdgeTension, eChamferEdgeOpen, eChamferEdgeInvert, eChamferEdgeSmooth, eChamferEdgeSmoothType, eChamferEdgeSmoothThreshold};
