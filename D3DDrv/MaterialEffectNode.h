#ifndef __materialeffectnode_h__
#define __materialeffectnode_h__
...
public:
	MaterialEffectNode(const class D3DDriver *pDriver);
...
public:
	...
	class D3DDriver			*m_p3DDriver;
};

#endif//__materialeffectnode_h__
