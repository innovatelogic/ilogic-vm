#ifndef __wtlpropertygrid_h__
#define __wtlpropertygrid_h__
...
public:
	...
	//----------------------------------------------------------------------------------------------
	LRESULT OnNotify(UINT msg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) //(int idCtrl, LPNMHDR pnmh, BOOL& bHandled)
	{
		if (m_bInit == TRUE)
		{
				...
				case CTRL_COLOR:
					{
						...
						DWORD Buffer = 0;// boost::lexical_cast<DWORD>(ascii);
